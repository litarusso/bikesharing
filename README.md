...
The data I used wasn't a proper data to analyse the date and time fields. So, I had to convert the "tripduration" column to date and time. You can find below the converted data types.
### -Image 2-
